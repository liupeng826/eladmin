 ...
 */
package me.zhengjie.modules.workflow.parser;

import me.zhengjie.modules.workflow.SnakerException;
import me.zhengjie.modules.workflow.helper.XmlHelper;
import me.zhengjie.modules.workflow.model.NodeModel;
import me.zhengjie.modules.workflow.model.ProcessModel;
import me.zhengjie.modules.workflow.model.TransitionModel;
import me.zhengjie.modules.workflow.parser.impl.*;
...
public class ModelParser {
    ...
    public static <T> T findByName(String name, Class<T> clazz) {
        ...
        contextMap.put("start", StartParser.class);
        contextMap.put("task", TaskParser.class);
        contextMap.put("custom", CustomParser.class);
        contextMap.put("decision", DecisionParser.class);
        contextMap.put("subprocess", SubProcessParser.class);
        contextMap.put("fork", ForkParser.class);
        contextMap.put("join", JoinParser.class);
        contextMap.put("end", EndParser.class);
    ...
    private static NodeModel parseModel(Node node) {
        ...
        try {
//            nodeParser = findByName(nodeName, NodeParser.class);
            switch (nodeName) {
                case "start":
                    nodeParser = new StartParser();
                    break;
                case "task":
                    nodeParser = new TaskParser();
                    break;
                case "custom":
                    nodeParser = new CustomParser();
                    break;
                case "decision":
                    nodeParser = new DecisionParser();
                    break;
                case "subprocess":
                    nodeParser = new SubProcessParser();
                    break;
                case "fork":
